...
class WorkoutController extends Controller
{
    ...
    {
        try {
            // Step 1: Validate and get input data
    $data = $request->validate([
    'user_type' => 'required|string|in:beginner,intermediate,advanced',
    ...
    'workout_type_preference' => 'nullable|string',
    'target_weight_goal' => 'nullable|string',
    'injuries_or_limitations' => 'nullable|array',
    'injuries_or_limitations.*' => 'string',
    'workout_time_per_session' => 'required|string',
